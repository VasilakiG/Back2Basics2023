...
int main()
{
    char firstCharacter = 65;  // ASCII value for the character 'A'
    char secondCharacter = 66; // ASCII value for the character 'B'
    char thirdCharacter = 67;  // ASCII value for the character 'C'
